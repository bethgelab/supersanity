...
This part of the repository is essentially a fork of the original Cambrian-S repository from here: https://github.com/cambrian-mllm/cambrian-s. The original README.md file is here: https://github.com/bethgelab/supersanity/blob/main/vsc_repeat/README_original.md. We describe the main set of steps required to reproduce the VSC-Repeat results here and defer other details to the original README and repository.
